CANONICAL_RES_NAME = {'  A', '  G', '  U', '  C', ' MG', ' NA',
                      ' MN', 'HOH', '  K', ' CA', '574', 'N79',
                      ' SR', ' NI', 'LIG', ' AU', ' CL', 'SO4',
                      'NH4', ' RB', ' TL', ' CS', ' BA', ' OS'}

ION_NAME = {' MG', ' NA', ' MN', '  K', ' CA'}
# {' MG', ' NA', ' MN', '  K', ' CA', ' SR', ' NI', ' AU',' RB', ' TL', ' CS', ' BA', ' OS'}
...
DICT_RES_NAME = {' RA': '  A', ' RG': '  G', ' RU': '  U', ' RC': '  C',
                 ...
                 ' MG': ' MG', ' NA': ' NA', ' MN': ' MN', '70U': '  U',
                 '12A': '  A', '2MU': '  U', 'HOH': 'HOH', '  K': '  K',
                 'IRI': 'LIG', '4BW': 'LIG', 'C2E': '  C', 'GAI': 'LIG',
                 'AGU': 'LIG', 'ACT': 'LIG', 'MGX': 'LIG', 'EGD': 'LIG',
                 'AG2': 'LIG', 'SPM': 'LIG', 'NCO': 'LIG', 'OHX': 'LIG',
                 'SPK': 'LIG', 'EPE': 'LIG', '6F7': 'LIG', 'ADE': 'LIG',
                 'GUN': 'LIG', '6AP': 'LIG', 'TPP': 'LIG', 'HPA': 'LIG',
                 '3AY': 'LIG'}


def modify_residue_atom_name1(residues):
